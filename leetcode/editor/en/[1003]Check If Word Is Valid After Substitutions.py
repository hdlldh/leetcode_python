...
#  Y (X concatenated with Y) is equal to V. (X or Y may be empty.) Then, X + "abc"
#  + Y is also valid. 
# 
#  If for example S = "abc", then examples of valid strings are: "abc", "aabcbc"
# , "abcabc", "abcabcababcc". Examples of invalid strings are: "abccba", "ab", "ca
# babc", "bac". 
# 
...
# Then we can insert "abc" before the last letter, resulting in "abcabcab" + "ab
# c" + "c" which is "abcabcababcc".
#  
# 
#  
#  Example 3: 

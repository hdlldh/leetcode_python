...
# 
#  We assign one unique bike to each worker so that the sum of the Manhattan dis
# tances between each worker and their assigned bike is minimized. 
# 
#  The Manhattan distance between two points p1 and p2 is Manhattan(p1, p2) = |p
# 1.x - p2.x| + |p1.y - p2.y|. 
# 
#  Return the minimum possible sum of Manhattan distances between each worker an
# d their assigned bike. 
# 
#  
# 
#  Example 1: 
...
# Output: 6
# Explanation: 
# We assign bike 0 to worker 0, bike 1 to worker 1. The Manhattan distance of bo
# th assignments is 3, so the output is 6.
#  
# 
#  Example 2: 
# 

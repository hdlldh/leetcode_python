# Under a grammar given below, strings can represent a set of lowercase words. L
# et's use R(expr) to denote the set of words the expression represents. 
# 
...
#  
#  
#  When we take a comma delimited list of 2 or more expressions, we take the uni
# on of possibilities.
#  
#  R("{a,b,c}") = {"a","b","c"} 
...
#  For expressions e_1, e_2, ... , e_k with k >= 2, we have R({e_1,e_2,...}) = R
# (e_1) ∪ R(e_2) ∪ ... 
#  For expressions e_1 and e_2, we have R(e_1 + e_2) = {a + b for (a, b) in R(e_
# 1) × R(e_2)}, where + denotes concatenation, and × denotes the cartesian product
# . 
#  
# 

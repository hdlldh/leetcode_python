...
# 
#  In one semester you can study any number of courses as long as you have studi
# ed all the prerequisites for the course you are studying. 
# 
...
# Output: 2
# Explanation: 
# In the first semester, courses 1 and 2 are studied. In the second semester, co
# urse 3 is studied.
#  
# 
#  Example 2: 

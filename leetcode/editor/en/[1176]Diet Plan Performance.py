...
# 
#  Given an integer k, for every consecutive sequence of k days (calories[i], ca
# lories[i+1], ..., calories[i+k-1] for all 0 <= i <= n-k), they look at T, the to
# tal calories consumed during that sequence of k days (calories[i] + calories[i+1
# ] + ... + calories[i+k-1]): 
# 
#  

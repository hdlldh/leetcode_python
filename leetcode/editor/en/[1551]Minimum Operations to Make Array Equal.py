# You have an array arr of length n where arr[i] = (2 * i) + 1 for all valid val
# ues of i (i.e. 0 <= i < n). 
# 
...
# 
#  Given an integer n, the length of the array. Return the minimum number of ope
# rations needed to make all the elements of arr equal. 
# 
#  
#  Example 1: 
# 

...
<p><strong>Note: </strong>You may assume that the secret number and your friend&#39;s guess only contain digits, and their lengths are always equal.</p><div><div>Related Topics</div><div><li>Hash Table</li></div></div>
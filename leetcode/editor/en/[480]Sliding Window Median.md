...
<p><b>Note: </b><br>
You may assume <code>k</code> is always valid, ie: <code>k</code> is always smaller than input array's size for non-empty array.</p><div><div>Related Topics</div><div><li>Sliding Window</li></div></div>
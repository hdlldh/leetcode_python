...
#has 2 glasses, and so on until the 100th row. Each glass holds one cup (250ml) o
#f champagne. 
#
# Then, some champagne is poured in the first glass at the top. When the top mos
...
#lass at the bottom row has it's excess champagne fall on the floor.) 
#
# For example, after one cup of champagne is poured, the top most glass is full.
# After two cups of champagne are poured, the two glasses on the second row are h
#alf full. After three cups of champagne are poured, those two cups become full -
# there are 3 full glasses total now. After four cups of champagne are poured, th
#e third row has the middle glass half full, and the two outside glasses are a qu
#arter full, as pictured below. 
#
# 
#
...
#is indexed as (0, 0)). There will be no excess liquid so all the glasses under t
#he top glass will remain empty.
#
#Example 2:

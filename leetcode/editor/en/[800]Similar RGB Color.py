...
#  example, "#15c" is shorthand for the color "#1155cc". 
# 
...
#  accepted. 
#  All inputs and outputs should use lowercase letters, and the output is 7 char
# acters. 
#  
...
class Solution(object):
    def similarRGB(self, color):
        ...
        return '#'+comp(color[1:3])+comp(color[3:5])+comp(color[5:7])
